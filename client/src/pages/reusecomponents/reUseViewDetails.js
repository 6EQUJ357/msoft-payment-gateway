                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">View Details</h4>
                         ...
                         <div className="card" id="demo">
                                ...
                                {params.value3 &&
                                 ...
                                 <div className="row p-4">
                                    ...
                                    <div className='col-lg-4 col-12'>Service Id</div>
                                    <div className='col-lg-8 col-12 mb-3'>
                                        <div className="form-control bg-light border-0">
                                     ...
                                     <div className="col-lg-12">
                                        <div className="card-body p-4">
                                            ...
                                            <div className="hstack gap-2 justify-content-end d-print-none mt-4">
                                                    ...
                                                    <Link to="/savedsubmitserviceform" className="btn btn-info" ><i className="ri-arrow-left-fill align-bottom me-1"></i>Back To List</Link>
...
export default ReuseViewDetails