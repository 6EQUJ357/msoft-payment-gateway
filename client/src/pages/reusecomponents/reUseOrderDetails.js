...
const ReuseOrderDetails = (params) => {
...
//get paymentDetails transaction data
    ...
    useEffect(()=>{
        axios.get(`${API_BASE_URL}/getorderdetails`).then(res=>setpaymentdetails(res.data)).catch(err=>console.log(err));
    },[])
...
//pass paymentDetails date to viewpaymentDetails details
    ...
    const deletepaymentDetails = (id, name)=>{
        ...
        if(response){
        axios.delete(`${API_BASE_URL}/deleteorderdetails/${id}`).then(res=>setpaymentdetails(res.data)).catch(err=>console.log(err));
    }
}
                            ...
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        <li className="breadcrumb-item"><a href="#a">Order</a></li>
                                        ...
                                        <table className="table table-hover table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr key={res._id}> 
                                                    ...
                                                    <td><p className="fw-medium mb-0">{res.service_id}</p></td>
                                                ...
                                                <tr>
                                                     <td>
                                                         <div className="form-check">
                                                             <h3 className="form-check-input">No Order History...</h3>
                                                         </div> 
                                                     </td>
                                                 </tr>
                                                 }
...
export default ReuseOrderDetails