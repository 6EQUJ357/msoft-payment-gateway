...
const ReuseSavedSubmitServiceForm = (params) => {

    // view  submitServiceForm details
...
//get submitServiceForm transaction data
    const [submitServiceForm, setsubmitserviceform] = useState([]);
    const [currentPage, setCurrentPage] = useState(1);
    const itemsPerPage = 10; // Number of items to display per page


    useEffect(()=>{
        axios.get(`${API_BASE_URL}/getsubmitserviceform`).then(res=>setsubmitserviceform(res.data)).catch(err=>console.log(err));
    },[])
     ...
     const handlePrevClick = () => {
      ...
      const totalPages = Math.ceil(submitServiceForm.length / itemsPerPage);
      ...
      const currentData = submitServiceForm.slice(startIndex, endIndex);

      //pagination ends


//pass submitServiceForm date to submitServiceForm details
    const handleClick =(data)=>{
        navigate('/ViewDetails', { state: data});
    }

    // delete submitServiceForm data

    const deletesubmitServiceForm = (id, name)=>{

        let response = window.confirm(`you try to delect the Client #${name}...`);
        if(response){
        axios.delete(`${API_BASE_URL}/deletsubmitServiceForm/${id}`).then(res=>setsubmitserviceform(res.data)).catch(err=>console.log(err));
    }
}
                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Submit Application</h4>

                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        <li className="breadcrumb-item"><a href="#a">Application</a></li>
                                        <li className="breadcrumb-item active">Submit Application</li>
                                    </ol>
                                </div>
                                                    ...
                                                    <td>
                                                        <div className="dropdown">
                                                            ...
                                                            <ul className="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <li>
                                                                    <button className="dropdown-item remove-item-btn" onClick={()=>deletesubmitServiceForm(res._id, res.clientname)}>
                    ...
                    <div className="row align-items-center mb-4 gy-3">
                        <div className="col-md-5">
                            <p className="mb-0 text-muted">Showing <b>1</b> to <b>10</b> of <b>{submitServiceForm.length}</b> results</p>
                        </div>
...
export default ReuseSavedSubmitServiceForm